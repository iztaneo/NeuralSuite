 ...
 */
double NitidezProyeccion(const std::vector<uint8_t>& tinta, int ancho, int alto,
                                double radianes);
 ...
 */
double EstimarInclinacion(const Bitmap& imagen, double rango_grados = 8.0,
 ...
 */
Bitmap Enderezar(const Bitmap& imagen, double* grados_aplicados = nullptr,
